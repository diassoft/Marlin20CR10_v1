...
//ODIAS2
//#if PREHEAT_COUNT
#if PREHEAT_COUNT && DISABLED(CUSTOM_DISABLE_PREHEAT_SETTINGS)
  ...
  //ODIAS2
  #if DISABLED(CUSTOM_DISABLE_COOLDOWN)
  void lcd_cooldown() {
...
//ODIAS2 added the DISABLE COOLDOWN
  //#if HAS_TEMP_HOTEND || HAS_HEATED_BED
  #if (HAS_TEMP_HOTEND || HAS_HEATED_BED) && DISABLED(CUSTOM_DISABLE_COOLDOWN)
